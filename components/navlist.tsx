...
import { ArrowRight, Briefcase, ChevronDown, User, Zap, Wrench } from 'lucide-react'
    ...
    <nav className="flex items-center gap-1">
      ...
      <div className="relative group">
        ...
        >
          {/* Key Services */}
          <a 
            href="/services/core#s" 
            className="block p-4 hover:bg-sky-600/20 transition-all duration-300 group/item border-b border-white/5"
          >
            <div className="flex items-center gap-3">
          ...
          {/* Service Department */}
          <a 
            href="/services/department#s" 
            className="block p-4 hover:bg-cyan-600/20 transition-all duration-300 group/item"
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-sky-500 rounded-lg flex items-center justify-center">
                <Wrench size={16} className="text-white" />
              </div>
              <div>
                <h4 className="text-slate-800 font-medium text-sm group-hover/item:text-cyan-700 transition-colors duration-300">
                  Service Department
                </h4>
                <p className="text-slate-600 text-xs mt-0.5">
                  Maintenance & support
              ...
              <ArrowRight size={16} className="text-slate-400 group-hover/item:text-cyan-600 group-hover/item:translate-x-1 transition-all duration-300 ml-auto" />
            </div>
          </a>
        </div>
      </div>
